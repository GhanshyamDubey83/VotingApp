...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <main class="content">
                <h3>Welcome to the Vote Information Page</h3>

                <table id="table02">
                    <tr class="tr2">
                        <th class="th2">Candidate Name</th>
                        <th  class="th2">Total Vote</th>
                    ...
                    <%
                        ...
                        ResultSet rs = smt.executeQuery("select vc_candidate,count(1) NumberOfVote from R5VOTEDCANDIDATE group by vc_candidate;");
                        while (rs.next()) {
                    %>
                    <tr class="tr2">
                        <td class="td2"><%=rs.getString("vc_candidate")%></td>
                        <td class="td2"><%=rs.getString("NumberOfVote")%></td>
